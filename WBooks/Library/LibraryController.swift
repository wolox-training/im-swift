...
class LibraryController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {        
        let bookDetailViewController = BookDetailController(nibName: "BookDetailController", bundle: nil)
        bookDetailViewController.bookDetailViewModel = libraryViewModel.getBookDetailViewModel(index: indexPath.section)
